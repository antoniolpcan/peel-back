...
class ChatService:
    ...
    async def get_or_create_chat(self, current_user_id: str, target_user_id: str) -> Chat:
    ...
    async def get_my_chats(self, user_id: str) -> list[Chat]:
        return await self.chat_repo.get_user_chats(user_id)

    async def send_message(self, chat_id: str, sender_id: str, message_in: MessageCreate) -> Message:
    ...
    async def get_chat_messages(self, chat_id: str, user_id: str, skip: int, limit: int) -> list[Message]:
    ...
    async def get_unread_messages_summary(self, user_id: str):
